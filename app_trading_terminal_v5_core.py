...
def top_card(row, rank):
    ...
    <div class='card' style='min-height:260px'>
      ...
      <div class='n'>{row.get('industry','未知')} ｜ {row.get('board','未知')}</div>
...
st.set_page_config(page_title="A股交易终端 V5 核心模块版", page_icon="🚀", layout="wide")
inject_css()
ensure_dirs()
...
st.markdown(f"""
<div class='hero'><h1>🚀 A股交易终端 V5 核心模块版</h1>
